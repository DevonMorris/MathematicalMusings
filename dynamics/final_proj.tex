...
\begin{enumerate}[a.]
  ...
  \item The simulation results in the following motion
    ...
    \begin{table}[H]
      ...
      \begin{tabular}{lcccccc}
        & $\omega_x$ & $\omega_y$ & $\omega_z$ & $\psi$ & $\theta$ & $\phi$ \\
        $\max$ &  23.3552 & 6.7834 & 2.5437 & 4.3394 & 0.0000 & 374.8002 \\
        $\min$ & -0.0590 & -5.5671 & -2.5836 & -67.8018 & -26.2249 & 0.0000 \\
      \end{tabular}
      \caption{Table of max and min values shown in degrees and degrees per second}
    \end{table}
At first glance, these results look totally incorrect and nonsensical, however, they are correct due to the weirdness of 3D rotations. We note that
\[
